...
use App\Entity\{AplicacionPlantillaAPPCC, ConfiguracionEntidadFiscal, ConfiguracionEstablecimiento, EntidadFiscal, Establecimiento, PlanControl, PlantillaAPPCC, PuntoControl, TareaAPPCC, TareaProgramada, Usuario, UsuarioEstablecimiento};
...
final class DemoSeedCommandTest extends PostgresTestCase
{
    public function testPrimeraEjecucionIdempotenciaRolesYLoginReal(): void
    {
        ...
        $local = $this->em->getRepository(Establecimiento::class)->findOneBy(['entidadFiscal' => $fiscal]);
